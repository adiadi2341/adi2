...
class Student:
    def __init__(self):
        ...
        self.grades = {}
        for i in range(int(input("how many grades there is: "))):
            self.grades[input("sub name: ")] = int(input("grade: "))
...
class Course:
    ...
    def __str__(self):
        return f"course number: {self.coursenum}, course name: {self.coursename}, \
         \n subs and teachers: {self.subs}, students: {self.students}, max course students:{self.maxstudents}"
